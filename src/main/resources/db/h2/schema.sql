...
CREATE UNIQUE INDEX priorityTypes_sequence ON priority_types (sequence);
...
ALTER TABLE specifications ADD CONSTRAINT fk_specifications_priority FOREIGN KEY (priority_id) REFERENCES priority_types (id);
...
ALTER TABLE specification_templates ADD CONSTRAINT fk_specification_templates_priority FOREIGN KEY (priority_id) REFERENCES priority_types (id);
...
ALTER TABLE stakeholders ADD CONSTRAINT fk_stakeholders_priority FOREIGN KEY (priority_id) REFERENCES priority_types (id);
...
ALTER TABLE stakeholder_templates ADD CONSTRAINT fk_stakeholder_templates_priority FOREIGN KEY (priority_id) REFERENCES priority_types (id);
...
ALTER TABLE specification_objectives ADD CONSTRAINT fk_specification_objectives_priority FOREIGN KEY (priority_id) REFERENCES priority_types (id);
...
ALTER TABLE objective_templates ADD CONSTRAINT fk_objective_templates_priority FOREIGN KEY (priority_id) REFERENCES priority_types (id);
...
ALTER TABLE stakeholder_objectives ADD CONSTRAINT fk_stakeholder_objectives_priority FOREIGN KEY (priority_id) REFERENCES priority_types (id);
