...
public final class ViewConstants {
    public static final String VIEW_SPECIFICATION_DEFAULT = "specification/default";
    ...
    public static final String VIEW_TEMPLATE_LINK_ADD_OR_UPDATE_FORM = "templateLink/addUpdateTemplateLink";
